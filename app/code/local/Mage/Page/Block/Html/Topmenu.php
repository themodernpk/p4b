    ...
    protected function _getHtml(Varien_Data_Tree_Node $menuTree, $childrenWrapClass)
    {
        ...
        foreach ($children as $child) {
            ...
            if ($child->hasChildren()) {
                $html .= '<li class="dropdown drawer-dropdown">';
            $html .= '<a href="#" ' . $outermostClassCode . ' data-toggle="dropdown" role="button" aria-expanded="false" >'
                . $this->escapeHtml($child->getName()) . ' <span class="caret"></span></a><div class="drawer-submenu dropdown-menu">';
            }
            else
            {
            $html .= '<li class="dropdown drawer-dropdown">';
            $html .= '<a href="' . $child->getUrl() . '" ' . $outermostClassCode . '>'
                . $this->escapeHtml($child->getName()) . '</a><div class="drawer-submenu dropdown-menu">';
            }
            if ($child->hasChildren()) {
