    ...
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('email', 'textarea', array(
            'name'     => 'email',
            'label'    => Mage::helper('contacts')->__('Testimonial Text 1'),
            'title'    => Mage::helper('contacts')->__('Testimonial Text 1'),
            'required' => false,
            'disabled' => $isElementDisabled
        ));
        ...
        $fieldset->addField('message', 'textarea', array(
            'name'     => 'message',
            'label'    => Mage::helper('testimonials')->__('Testimonial Text 2'),
            'title'    => Mage::helper('testimonials')->__('Testimonial Text 2'),
            'required' => false,
            'disabled' => $isElementDisabled
        ));
