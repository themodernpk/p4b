...
class NeoTheme_Blog_Block_Adminhtml_Post_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
   public function __construct()
   {
        ...
        $this->setTitle('<img src="' . $this->getSkinUrl('images/neotheme/blog/blog-logo.gif') . '"/><br />'.Mage::helper('neotheme_blog')->__('FAQS'));
        $this->setHeader(Mage::helper('neotheme_blog')->__('FAQ'));
   }
   ...
   protected function _beforeToHtml()
   {
        $this->addTab('form_section', array(
        			  'label'     => Mage::helper('neotheme_blog')->__('Faq Question'),
       ...
       $this->addTab('content_section', array(
           'label'     => Mage::helper('neotheme_blog')->__('Faq Answer'),
